export default function get_kcrit_m(lambda_rel_m_y, lambda_rel_m_z) {
    ...
    return {
        ...
        kcrit_m_y_title: `\\lambda_{rel,m,y} = `,
        ...
        kcrit_m_y_formulaVal: lambda_rel_m_y <= 0.75 ? ``
            : 0.75 < lambda_rel_m_y && lambda_rel_m_y <= 1.4 ? `1.56-0.75\\cdot${lambda_rel_m_y} = `
                : `\\dfrac{1}{${lambda_rel_m_y}^2} = `,
        ...
        kcrit_m_z_title: `\\lambda_{rel,m,z} = `,
        ...
        kcrit_m_z_formulaVal: lambda_rel_m_z <= 0.75 ? ``
            : 0.75 < lambda_rel_m_z && lambda_rel_m_z <= 1.4 ? `1.56-0.75\\cdot${lambda_rel_m_z} = `
                : `\\dfrac{1}{${lambda_rel_m_z}^2} = `,
