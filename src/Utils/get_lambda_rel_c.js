...
export default function get_lambda_rel_c(lambda_c_y,lambda_c_z,fc0k,E0_05) {
    ...
    return {
        ...
        lambda_rel_c_y_formula: `\\dfrac{\\lambda_{c,y}}{\\pi}\\cdot\\sqrt{\\dfrac{f_{c,0,k}}{E_{0,05}}} = `,
        ...
        lambda_rel_c_z_formula: `\\dfrac{\\lambda_{c,z}}{\\pi}\\cdot\\sqrt{\\dfrac{f_{c,0,k}}{E_{0,05}}} = `,
        lambda_rel_c_z_formulaVal: `\\dfrac{${customDecimal(lambda_c_z)}}{\\pi}\\cdot\\sqrt{\\dfrac{${customDecimal(fc0k)}}{${customDecimal(E0_05)}}} = `,
