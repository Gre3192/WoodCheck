...
export default function get_k(beta_c, lambda_rel_c_y, lambda_rel_c_z) {
    ...
    return {
        ...
        k_y_formulaVal: `0.5\\cdot\\left[1+${customDecimal(beta_c)} \\cdot\\left(${customDecimal(lambda_rel_c_y)}-0.3\\right)\\cdot ${customDecimal(lambda_rel_c_y)}^2\\right] = `,
        k_y_description: ``,
        ...
        k_z_formulaVal: `0.5\\cdot\\left[1+${customDecimal(beta_c)} \\cdot\\left(${customDecimal(lambda_rel_c_z)}-0.3\\right)\\cdot ${customDecimal(lambda_rel_c_z)}^2\\right] = `,
        k_z_description: ``,
