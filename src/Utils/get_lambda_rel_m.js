...
export default function get_lambda_rel_m(fmk, sigma_m_crit_y, sigma_m_crit_z) {
    ...
    return {
        ...
        lambda_rel_m_y_formulaVal: `\\sqrt{\\dfrac{${customDecimal(fmk)}}{${customDecimal(sigma_m_crit_y)}}} = `,
        ...
        lambda_rel_m_z_formulaVal: `\\sqrt{\\dfrac{${customDecimal(fmk)}}{${customDecimal(sigma_m_crit_z)}}} = `,
