...
import Selector from './ElementUI/Selector';


export default function DurationClassSelectorCopy({ viewType = 'table' }) {
  ...
  return (
    <>
      {false ?
        ...
        //     <InputLabel id="demo-simple-select-label">Classe di durata</InputLabel>
        //     <Select
        ...
        //     >
        //       {classes.map((item) => (
        //         <MenuItem value={item.value}>{'Carico '}{capitalizeFirstLetter(item.value)}</MenuItem>
        //       ))}
        //     </Select>
        //   </FormControl>
        // </Box>
