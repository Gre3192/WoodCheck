                    ...
                    <g>
                        {Med_y > 0 && Ved_y > 0 ?
                            <g transform={`translate(60, 0)`}>
                                ...
                                <text x="-10" y="168" font-family="Verdana" font-weight="600" font-size="16" fill="#479E5A" textAnchor="end">{`${Math.abs(Med_y)}`}</text>

                                <path d="M0 136L21.6 148.471L21.6 123.529L0 136ZM19.44 138.16H97V133.84H19.44V138.16Z" fill="#C10D10" />
                                <text x="-10" y="140" font-family="Verdana" font-weight="600" font-size="16" fill="#C10D10" textAnchor="end">{`${Math.abs(Ved_y)}`}</text>
                            </g> : null
                        }
                        {!(Med_y > 0 && Ved_y > 0) && Med_y > 0 ?
                            <g>
                                ...
                                <text x="50" y="156" font-family="Verdana" font-weight="600" font-size="16" fill="#479E5A" textAnchor="end">{`${Math.abs(Med_y)}`}</text>
                            </g> : null
                        }
                        {!(Med_y > 0 && Ved_y > 0) && Ved_y > 0 ?
                            <g>
                                <path d="M58 149L79.6 161.471V136.529L58 149ZM77.44 151.16H155V146.84H77.44V151.16Z" fill="#C10D10" />
                                <text x="50" y="156" font-family="Verdana" font-weight="600" font-size="16" fill="#7B1010" textAnchor="end">{`${Math.abs(Ved_y)}`}</text>
                            </g> : null
                        }
                    </g>
                    ...
                    <g>
                        {Med_y < 0 && Ved_y < 0 ?
                            <g transform={`translate(60, 0)`}>
                                ...
                                <text x="255" y="140" font-family="Verdana" font-weight="600" font-size="16" fill="#479E5A">{`${Math.abs(Med_y)}`}</text>

                                <path d="M247 162L225.4 174.471V149.529L247 162ZM227.56 164.16H150V159.84H227.56V164.16Z" fill="#C10D10" />
                                <text x="255" y="168" font-family="Verdana" font-weight="600" font-size="16" fill="#C10D10">{`${Math.abs(Ved_y)}`}</text>
                            </g> : null
                        }
                        {!(Med_y < 0 && Ved_y < 0) && Med_y < 0 ?
                            <g>
                                ...
                                <text x="310" y="154" font-family="Verdana" font-weight="600" font-size="16" fill="#479E5A" textAnchor="start">{`${Math.abs(Med_y)}`}</text>
                            </g> : null
                        }
                        {!(Med_y < 0 && Ved_y < 0) && Ved_y < 0 ?
                            <g>
                                <path d="M305 149L283.4 161.471L283.4 136.529L305 149ZM285.56 151.16H208V146.84H285.56V151.16Z" fill="#C10D10" />
                                <text x="310" y="154" font-family="Verdana" font-weight="600" font-size="16" fill="#7B1010" textAnchor="start">{`${Math.abs(Ved_y)}`}</text>
                            </g> : null
                        }
                    </g>
                    ...
                    <g>
                        {Med_z < 0 && Ved_z < 0 ?
                            <g transform={`translate(60, 0)`}>
                                ...
                                <text x="85" y="270" font-family="Verdana" font-weight="600" font-size="16" fill="#479E5A" textAnchor="end">{`${Math.abs(Med_z)}`}</text>

                                <path d="M137 297L124.529 275.4H149.471L137 297ZM134.84 277.56V200H139.16V277.56H134.84Z" fill="#C10D10" />
                                <text x="150" y="270" font-family="Verdana" font-weight="600" font-size="16" fill="#7B1010">{`${Math.abs(Ved_z)}`}</text>
                            </g> : null
                        }
                        {!(Med_z < 0 && Ved_z < 0) && Med_z < 0 ?
                            <g>
                                ...
                                <text x="200" y="270" font-family="Verdana" font-weight="600" font-size="16" fill="#479E5A">{`${Math.abs(Med_z)}`}</text>
                            </g> : null
                        }
                        {!(Med_z < 0 && Ved_z < 0) && Ved_z < 0 ?
                            <g>
                                ...
                                <text x="200" y="270" font-family="Verdana" font-weight="600" font-size="16" fill="#7B1010">{`${Math.abs(Ved_z)}`}</text>
                            </g> : null
                        }
                    </g>
                    ...
                    <g>
                        {Med_z > 0 && Ved_z > 0 ?
                            <g transform={`translate(60, 0)`}>
                                ...
                                <text x="160" y="40" font-family="Verdana" font-weight="600" font-size="16" fill="#479E5A">{`${Math.abs(Med_z)}`}</text>

                                <path d="M110 0L122.471 21.6H97.5292L110 0ZM112.16 19.44L112.16 97H107.84L107.84 19.44H112.16Z" fill="#C10D10" />
                                <text x="95" y="40" font-family="Verdana" font-weight="600" font-size="16" fill="#7B1010" textAnchor="end">{`${Math.abs(Ved_z)}`}</text>
                            </g> : null
                        }
                        {!(Med_z > 0 && Ved_z > 0) && Med_z > 0 ?
                            <g>
                                ...
                                <text x="200" y="40" font-family="Verdana" font-weight="600" font-size="16" fill="#479E5A">{`${Math.abs(Med_z)}`}</text>
                            </g> : null
                        }
                        {!(Med_z > 0 && Ved_z > 0) && Ved_z > 0 ?
                            <g>
                                <path d="M182 0L194.471 21.6H169.529L182 0ZM184.16 19.44V97H179.84V19.44H184.16Z" fill="#C10D10" />
                                <text x="200" y="40" font-family="Verdana" font-weight="600" font-size="16" fill="#7B1010">{`${Math.abs(Ved_z)}`}</text>
                            </g> : null
                        }
                    </g>
                    ...
                    <g>
                        {Ned < 0 ?
                            <g>
                                ...
                                <text x="182" y="190" font-family="Verdana" font-weight="600" font-size="16" fill="#004DB2" textAnchor="middle">{`${Math.abs(Ned)}`}</text>
                            </g>
                            : null
                        }
                        {Ned > 0 ?
...

                    {
                        Med_tor > 0 ?
                            <g>
                                ...
                                <text x="220" y="110" font-family="Verdana" font-weight="600" font-size="16" fill="#000000" textAnchor="start" >{`${Math.abs(Med_tor)}`}</text>
                            </g> : null
                    }
                    {
                        Med_tor < 0 ?
