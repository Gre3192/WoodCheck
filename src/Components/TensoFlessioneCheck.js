...
export default function TensoFlessioneCheck(params) {
    ...
    const finalContent
        = <div className="flex flex-col gap-5">
            <Latex>{`$\\displaystyle\\frac{\\sigma_{t,0,d}}{f_{t,0,d}} + \\frac{\\sigma_{m,y,d}}{f_{m,y,d}} + k_m\\cdot\\frac{\\sigma_{m,z,d}}{f_{m,z,d}} = \\dfrac{${Ned}}{${NcRd}} = ${check}${getCheckSymbol(check)}$`}</Latex>
            <Latex>{`$\\displaystyle\\frac{\\sigma_{t,0,d}}{f_{t,0,d}} + k_m\\cdot\\frac{\\sigma_{m,y,d}}{f_{m,y,d}} + \\frac{\\sigma_{m,z,d}}{f_{m,z,d}} = \\dfrac{${Ned}}{${NcRd}} = ${check}${getCheckSymbol(check)}$`}</Latex>
        </div>
