...
export default function SteelSectionGeometryMass({ sectionGeometryMass }) {
    ...
    const minimalTableGeometryMassConfig = [
        { label: 'A_{tot}\\\\\\text{[$mm^2$]}', value: customDecimal(sectionGeometryMass.valori.A, 2), textHover: 'Area totale' },
                        ...
                        <table className="min-w-full bg-white border border-gray-300 rounded-lg shadow-lg">
                            ...
                            <tbody>
                                ...
                                <tr className="border-t">
                                    ...
                                    <td className="px-4 py-2"><Latex>{sectionGeometryMass.formule.A}</Latex></td>
                                    <td className="px-4 py-2">{customDecimal(sectionGeometryMass.valori.A, 2)}</td>
                                </tr>
